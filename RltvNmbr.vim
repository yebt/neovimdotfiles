...
" ---------------------------------------------------------------------
" RltvNmbr: {{{2
"  mode=1: initial placement of signs
"      =2: remove and replace signs
"      =3: remove signs
fun! s:RltvNmbr(mode,...)
...
"	call Decho("s:rltvnmbr_botline_".bufnr("%")."=".s:rltvnmbr_botline_{bufnr("%")})
	...
	if wc != s:rltvnmbr_curline_{bufnr("%")} || wt != s:rltvnmbr_topline_{bufnr("%")} || wb != s:rltvnmbr_wbotline_{bufnr("%")} || fb != s:rltvnmbr_botline_{bufnr("%")}
